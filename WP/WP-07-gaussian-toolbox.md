...
Version 0.1 · Drafted 2026-07-14 · Ratified and sealed 2026-07-14 · Status: **Ratified** (GT1 landed + §27 sealed at `CONVENTION_VERSION` 0.6, 2026-07-14; GT2 purity/entropy + GT4 log-negativity/separability + GT5 effective-temperature landed 2026-07-15; **GT3a generic congruence + GT3b ion `S`-adapter landed 2026-07-15** (GT3b consumer side; producer `IonModeBasis` emitter = independent `iontrap-structure` work); GT6 open)
