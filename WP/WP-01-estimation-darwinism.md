...
WP-01 v0.3 · ID WP-01-estimation-darwinism · Drafted 2026-06-02 · Ratified 2026-06-02 · Oxford British English · **Lifecycle: Released** (per `WP/README.md` §3) — **`v0.5.0` tagged 2026-06-03** (commit `c294b5b`). All WIs (WI-1…WI-4) + the six §7 benchmarks landed (dispatches **EDA–EDF**); CONVENTIONS **§19–22 sealed** at the v0.3 Convention Freeze (commit `fdcd20f`, combined with WP-02 §23–24, `CONVENTION_VERSION` 0.2 → 0.3); shipped in the `v0.5.0` additive minor release (the §10 release cut, combined with WP-02 P0).
