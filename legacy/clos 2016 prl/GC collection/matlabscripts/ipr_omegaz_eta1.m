...
out   = [out;[omegaz, IPR_av, IPR, N, OmegaR, cutoff, eta0, meanE, DE]];
disp(['N, wz, Iav, I = ',num2str(N), '  ',num2str(omegaz),'  ',num2str(IPR_av),'  ',num2str(IPR)])
end
export=table(round(out,4));
filename=['/home/gclos/Dokumente/QSIM/Paula/SpinBoson/' num2str(N) 'ions_IPR_av_eta1_nval' num2str(nval(1)) '.txt']
