...
out   = [out;[cutoff, IPR_av, IPR, N, omegaz, OmegaR]];
disp(['N, nc, Iav, I = ',num2str(N), '  ',num2str(cutoff),'  ',num2str(IPR_av),'  ',num2str(IPR)])
end
export=table(round(out,4));
filename=['/home/gclos/Dokumente/QSIM/Paula/SpinBoson/' num2str(N) 'ions_ipr_vs_nc.txt']
