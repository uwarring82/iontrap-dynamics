...
:func:`sample_outcome` orchestrator. Binomial / Poisson channels, detector
models, protocols, and statistics follow in Dispatches I–O. The
...
from .channels import BernoulliChannel, sample_outcome
